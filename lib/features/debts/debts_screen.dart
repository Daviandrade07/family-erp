          ...
          children: [
            ...
            debts.maybeWhen(
              data: (list) {
                ...
                // Card neutro: dívida em aberto é fato, não urgência —
                // vermelho fica reservado para o que exige ação hoje.
                return AppCard(
                  child: Column(
          ...
          children: [
            Row(
              children: [
                ...
                // Prioridade não é urgência: texto neutro, sem badge colorido.
                Text('Prioridade ${debt.priority.labelPt.toLowerCase()}',
                    style: text.labelSmall),
                if (onDelete != null)
                  IconButton(
