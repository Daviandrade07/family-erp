...
/// Assinatura da transcrição — injetável via [transcriptionProvider] para os
/// testes substituírem o Whisper real por um fake.
typedef TranscribeFn = Future<String> Function(
  Uint8List bytes, {
  String filename,
  String contentType,
});
...
/// Ponto único de acesso à transcrição (chat e Registro Rápido).
final transcriptionProvider =
    Provider<TranscribeFn>((ref) => audioTranscriptionService.transcribe);
