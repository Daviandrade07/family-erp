...
///
/// 1. **Chave manual** (usuário colou uma chave em Configurações): chama a
///    Groq direto com essa chave. Para usuários avançados / chave própria.
...
class AiConfig {
  ...
  /// Chave manual salva no dispositivo (vazia = não configurada).
  static String get manualKey =>
      _override.isNotEmpty ? _override : Env.aiApiKey;
  ...
  /// Carrega a chave manual salva no dispositivo. Chamar no arranque.
