...
class ClaudeAssistantService {
  ...
  Future<Map<String, dynamic>> _post() async {
    // A chave Anthropic nunca deve ser enviada por um cliente distribuído.
    // Produção usa exclusivamente a Edge Function autenticada.
    if (!Env.hasAiProxy) {
      throw StateError('Assistente seguro indisponível: configure AI_PROXY_URL.');
    }
